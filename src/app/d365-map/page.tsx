...
const modules: BCModule[] = [
  ...
  },
  {
    ...
    d365: 'NovaPOS Finance',
    route: '/finance/cost-accounting',
    status: 'built',
    description: 'Cost centers, overhead allocation, profitability by department',
  ...
  },
  {
    ...
    route: '/hr/payroll',
    status: 'built',
    description: 'Payroll runs, gross/net pay, deductions, posting',
  ...
  },
  {
    ...
    route: '/finance/tax',
    status: 'built',
    description: 'Sales tax, VAT configuration, transaction ledger',
