...
const SEED_INTEGRATIONS = [
  ...
  { featureName: 'CRM Integration', featureCategory: 'crm', description: 'Sync customers to NovaPOS Customer Insights', thirdPartyName: 'NovaPOS CRM', estimatedCost: '$1,500/mo', status: 'native_built', priority: 'high', nativeAlternative: 'Native CRM module' },
