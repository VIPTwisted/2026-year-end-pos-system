...
const DOCTYPE_COLOR: Record<string, string> = {
  ...
  'Finance Charge': 'bg-red-500/20 text-red-400',
}
        ...
        <div className="px-6 py-4 space-y-5">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <h2 className="text-[18px] font-semibold text-zinc-100">Customer Ledger Entries</h2>
          ...
          {entries.length === 0 ? (
            <div className="bg-[#16213e] border border-zinc-800/50 rounded-lg flex flex-col items-center justify-center py-16">
              ...
              <p className="text-[13px] text-zinc-500">No customer ledger entries.</p>
            </div>
          ) : (
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="border-b border-zinc-800/60">
                    <tr>
                      {['Entry No.', 'Posting Date', 'Doc. Type', 'Doc. No.', 'Customer No.', 'Description', 'Curr.', 'Debit', 'Credit', 'Remaining', 'Open'].map(h => (
                  ...
                  <tbody className="divide-y divide-zinc-800/40">
                    {entries.map(e => (
                      <tr key={e.id} className="hover:bg-zinc-800/30 transition-colors">
                        ...
                        <td className="px-4 py-3 font-mono text-[11px] text-blue-400">{e.customerNo ?? '—'}</td>
